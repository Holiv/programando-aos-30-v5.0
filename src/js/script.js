...
card_1.addEventListener("touchstart", function () {
  menuMove(card_0, card_1, 1, hideCard0, hideCard1, showCard0, showCard1);
});
card_2.addEventListener("touchstart", function () {
  menuMove(card_0, card_2, 2, hideCard0, hideCard2, showCard0, showCard2);
});
card_3.addEventListener("touchstart", function () {
  menuMove(card_0, card_3, 3, hideCard0, hideCard3, showCard0, showCard3);
});
...
const showSideMenu = () => {
  ...
  menuBar01
    ? rotateFunctionRemove(toggleBar[0], toggleBar[2])
    : rotateFunctionAdd(toggleBar[0], toggleBar[2]);
};
